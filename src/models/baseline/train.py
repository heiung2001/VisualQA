...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default=r'C:\Users\hieunc15\Documents\VisualQA\data\processed',
                        help='input directory for visual question answering.')

    parser.add_argument('--log_dir', type=str, default='./logs',
                        help='directory for logs.')

    parser.add_argument('--model_dir', type=str, default=r'C:\Users\hieunc15\Documents\VisualQA\models\baseline',
